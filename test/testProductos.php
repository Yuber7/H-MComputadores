...
$insert = new Productos([ "id" => 2, "nombre" => "Teclado asda", "marca" => "asus", "categoria_id" => 1,  "referencia_fabrica" => "12343", "descripcion" => "mansa", "stock" => 12, "precio" => 20000,  "estado" => "Disponible"     ]);
$insert->save();
