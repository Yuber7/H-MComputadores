...
<html>
<head>
    <title><?= $_ENV['TITLE_SITE'] ?> | Editar Foto</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Editar o Actualizar Foto</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?= $baseURL; ?>/views/">Fotos</a></li>
            ...
            <?php if (!empty($_GET['respuesta'])) { ?>
                <?php if ($_GET['respuesta'] != "correcto") { ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        Error al editar la foto: <?= $_GET['mensaje'] ?>
                    </div>
                <?php } ?>
            <?php } ?>
            <div class="container-fluid">
                        ...
                        <div class="card card-info">
                            ...
                            <?php if (!empty($_GET["id"]) && isset($_GET["id"])) { ?>
                                ...
                                if (!empty($DataFotos)) {
                                    ...
                                    <div class="card-body">
                                    <!-- form start -->
                                    <form class="form-horizontal" method="post" id="frmEditFoto"
                                          name="frmEditFoto"
                                          action="../../../app/Controllers/FotosController.php?action=edit">

                                        <input id="id" name="id" value="<?php echo $DataFotos->getId(); ?>" hidden
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input required type="text" class="form-control" id="descripcion" name="descripcion"
                                                       ...
                                                       value="<?php echo $DataFotos->getDescripcion(); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input required type="text" class="form-control" id="ruta"
                                                       ...
                                                       value="<?php echo $DataFotos->getRuta(); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select id="estado" name="estado" class="custom-select">
                                                    <option <?= ($DataFotos->getEstado() == "Activo") ? "selected" : ""; ?> value="Activo">Activo</option>
                                                    <option <?= ($DataFotos->getEstado() == "Inactivo") ? "selected" : ""; ?> value="Inactivo">Inactivo</option>
                                                </select>
                                            </div>
                                        </div>
