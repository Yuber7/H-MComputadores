                                        ...
                                        <div class="col-sm-8">
                                            <?= PersonasController::selectPersona(
                                                array (
                                                    ...
                                                    'defaultValue' => (!empty($dataCompra)) ? $dataCompra->getAdministrador()->getId() : '',
                                    ...
                                    <div class="col">
                                        <table id="tblDetalleProducto"
                                            ...
                                            if (!empty($dataCompra) and !empty($dataCompra->getId())) {
                                                $arrDetalleCompras = DetalleCompras::search("SELECT * FROM `h&mcomputadores`.detalle_compras WHERE compra_id = ".$dataCompra->getId());
