<?php
require_once("../../../app/Controllers/DepartamentosController.php");
...
<html>
<head>
    <title><?= $_ENV['TITLE_SITE'] ?> | Gestionar Departamentos</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-dark">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-user"></i>  Gestionar Departamentos</h3>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <table id="tblDepartamentos" class="datatable table table-bordered table-striped">
                                            <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Nombre</th>
